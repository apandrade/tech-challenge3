...
tokenizer = BartTokenizer.from_pretrained("../models-tuned/bart-final")
model = BartForConditionalGeneration.from_pretrained('../models-tuned/bart-final')
...
title = r"Inferência Bart Final (100% da base)"
